      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: NetworkImage(
                "https://i.postimg.cc/W14z7zWX/luis-eusebio-5-SUt9q8j-Qr-Q-unsplash.jpg"),
            fit: BoxFit.cover,
          ),
        ),
        child: MyLoginForm(),
...
class MyLoginFormState extends State<MyLoginForm> {
  ...
  void login(BuildContext context) async {
    ...
    print(bUser);
    try {
      String url = widget.url_base +
          "loginUser"; //Serve a passare l'id da una view all' altra
      ...
      if (utente["id"] == -1) {
        ...
        Navigator.push(
            context,
            CupertinoPageRoute(
                builder: (context) => EditProfilePage(utente: utente)));
        setState(() {});
      }
    } catch (err) {
      print(err);
